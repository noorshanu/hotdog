    ...
    <nav className="   py-1  w-full z-40 ">
      <div className="max-w-6xl mx-auto  flex justify-between items-center   px-4 py-1 ">
        ...
        <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <h1 className="v font-dream text-xl sm:text-3xl font-bold text-black ">$ H<span className="text-[#de0718]">DOG</span></h1>
        </a>
        ...
        <a
                  href="https://x.com/Hotdog_Solanaa" rel="noreferrer" target="_blank"
      ...
      >
        {(ref) => (
          ...
          >
            ...
            <a
                  href="https://x.com/Hotdog_Solanaa"
                  className=" text-xl text-white bg-black hover:bg-[#1a4093] rounded-full p-2 border-2 border-[#000]  hover:text-[#fff]"
                >
                  <BsTwitterX />
                </a>
